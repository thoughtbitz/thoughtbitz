    ...
    <div class="col-lg-8">
      ...
      <p id = "po">
            ...
            <hr>
             ...
             Many later languages have borrowed syntax/features directly or indirectly from C language. Like syntax of Java, PHP, JavaScript, and many other languages are mainly based on C language. C++ is nearly a superset of C language (There are few programs that may compile in C, but not in C++).<br><br>
            ...
            <br>
              ...
              <div id="second">
              <h1>2.Machine Independent or Portable </h1>
            ...
            <div id="second">
              <h1>3.Mid-level programming language</h1>
             Although, C is intended to do low-level programming. It is used to develop system applications such as kernel, driver, etc. It also supports the features of a high-level language. That is why it is known as mid-level language.
              ...
              <div id="second">
              <h1>4.Structured programming language</h1>
