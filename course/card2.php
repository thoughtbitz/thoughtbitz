<?php
    ...
    if(isset($_POST['mac1'])){
      $q = "update c_course set $a = 1, percentage = $c where uid = $b and lid = $lid ";
      mysqli_query($con,$q);
      header('Location:card_structure.php');
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<nav class="navbar navbar-expand-lg navbar-light sticky-top" style="background-color: #e3f2fd;">
  <a class="navbar-brand" href="#">Thoughtbitz logo</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="#">ThoughtBITZ</a>
          <a class="dropdown-item" href="#">ThoughtBitz</a>
      ...
      <li class="nav-item">
        <a class="nav-link disabled" href="#">ThoughtBitz</a>
      </li>
    </ul>
...
<div class="container-fluid">
  ...
  <div class="row content">
    ...
    <div class="col-lg-8">
      ...
      <div class="row m-4">
    <form method="post">
    <button class="btn btn-primary " name="mac1" type= "submit" id="mac" disabled  onclick="check();">Mark as Completed</button>
  </form>
  </div>
    </div>
