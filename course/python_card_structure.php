...
<?php 
    ...
    $lid  = trim(urldecode(base64_decode($_GET['lid'])),'dashboard viewposts');
...
<body>
  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
            ...
            <ul class="navbar-nav mr-auto mx-auto apply">
                ...
                <button class="nav-link navb text-white btn" id="quiz" onclick=window.location.assign("quiz.php");  disabled style=" cursor: not-allowed;">Quiz </button>
                </li>
                <li class="nav-item navs px-5">
                <button class="nav-link navb text-white btn" id="certificate" onclick=window.location.assign("https://www.thoughtbitz.ml/course/Certificate/display1.php");  disabled style="cursor: not-allowed;">Certificate</button>
            </li>
...
<div class="row mt-5 ml-3 mr-3">
  <div class="column">
    <div class="card">
      ...
      <div>
                ...
                <a href="./C_content/c_card1.php?lid=2&&topicid=<?php echo $id[1] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th"></a>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./C_content/c_card2.php?lid=2&&topicid=<?php echo $id[2] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac2"></a>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       ...
       <div>
                  <a href="./C_content/c_card3.php?lid=2&&topicid=<?php echo $id[3] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac3"></a>
      </div>
      <div class="card-text text-right">
             <?php       lock('ac3');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./C_content/c_card4.php?lid=2&&topicid=<?php echo $id[4] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac4"></a>
      </div>
   <div class="card-text text-right">
      <?php       lock('ac4');      ?>
      </div>
...
<div class="row mt-3 ml-3 mr-3">
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./C_content/c_card5.php?lid=2&&topicid=<?php echo $id[5] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac5"></a>
      </div>
       <div class="card-text text-right">
             <?php       lock('ac5');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./C_content/c_card6.php?lid=2&&topicid=<?php echo $id[6] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac6"></a>
      </div>
      <div class="card-text text-right">
         <?php       lock('ac6');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       ...
       <div>
                  <a href="./C_content/c_card7.php?lid=2&&topicid=<?php echo $id[7] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac7"></a>
      </div>
       <div class="card-text text-right">
           <?php       lock('ac7');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./C_content/c_card8.php?lid=2&&topicid=<?php echo $id[8] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac8"></a>
      </div>
       <div class="card-text text-right">
           <?php       lock('ac8');      ?>
      </div>
...
<div class="row mt-3 ml-3 mr-3">
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./C_content/c_card9.php?lid=2&&topicid=<?php echo $id[9] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac9"></a>
      </div>
       <div class="card-text text-right">
           <?php       lock('ac9');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       ...
       <div>
                  <a href="./C_content/c_card10.php?lid=2&&topicid=<?php echo $id[10] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac10"></a>
      </div>
       <div class="card-text text-right">
             <?php       lock('ac10');      ?>
      </div>
  ...
  <div class="column">
   ...
   <div>
                  <a href="./C_content/c_card11.php?lid=2&&topicid=<?php echo $id[11] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac11"></a>
      </div>  
       <div class="card-text text-right">
           <?php       lock('ac11');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./C_content/c_card12.php?lid=2&&topicid=<?php echo $id[12] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac12"></a>
      </div>
       <div class="card-text text-right">
             <?php       lock('ac12');      ?>
      </div>
...
<div class="row mt-3 ml-3 mr-3 mb-3">
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./C_content/c_card13.php?lid=2&&topicid=<?php echo $id[13] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac13"></a>
      </div>
      <div class="card-text text-right">
           <?php       lock('ac13');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./C_content/c_card14.php?lid=2&&topicid=<?php echo $id[14] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac14"></a>
      </div>
   <div class="card-text text-right">
         <?php       lock('ac14');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./C_content/c_card15.php?lid=2&&topicid=<?php echo $id[15] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac15"></a>
      </div>
      <div class="card-text text-right">
         <?php       lock('ac15');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./C_content/c_card16.php?lid=2&&topicid=<?php echo $id[16] ;?>"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac16"></a>
      </div>
       <div class="card-text text-right">
           <?php       lock('ac16');      ?>
      </div>
