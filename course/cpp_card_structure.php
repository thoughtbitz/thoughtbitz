...
<body>
  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
            ...
            <ul class="navbar-nav mr-auto mx-auto apply">
                ...
                <button class="nav-link navb text-white btn" id="quiz" onclick=window.location.assign("cpp_quiz.php");  disabled style=" cursor: not-allowed;">Quiz </button>
                </li>
                <li class="nav-item navs px-5">
...
<div class="row mt-5 ml-3 mr-3">
  <div class="column">
    <div class="card">
      ...
      <div>
                ...
                <a href="./cpp_content/cpp_card1.php"  class="position-absolute w-100 h-100 text-decoration-none th"></a>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./cpp_content/cpp_card2.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac2"></a>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       ...
       <div>
                  <a href="./cpp_content/cpp_card3.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac3"></a>
      </div>
      <div class="card-text text-right">
             <?php       lock('ac3');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./cpp_content/cpp_card4.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac4"></a>
      </div>
   <div class="card-text text-right">
      <?php       lock('ac4');      ?>
      </div>
...
<div class="row mt-3 ml-3 mr-3">
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./cpp_content/cpp_card5.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac5"></a>
      </div>
       <div class="card-text text-right">
             <?php       lock('ac5');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./cpp_content/cpp_card6.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac6"></a>
      </div>
      <div class="card-text text-right">
         <?php       lock('ac6');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       ...
       <div>
                  <a href="./cpp_content/cpp_card7.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac7"></a>
      </div>
       <div class="card-text text-right">
           <?php       lock('ac7');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./cpp_content/cpp_card8.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac8"></a>
      </div>
       <div class="card-text text-right">
           <?php       lock('ac8');      ?>
      </div>
...
<div class="row mt-3 ml-3 mr-3">
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./cpp_content/cpp_card9.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac9"></a>
      </div>
       <div class="card-text text-right">
           <?php       lock('ac9');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       ...
       <div>
                  <a href="./cpp_content/cpp_card10.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac10"></a>
      </div>
       <div class="card-text text-right">
             <?php       lock('ac10');      ?>
      </div>
  ...
  <div class="column">
   ...
   <div>
                  <a href="./cpp_content/cpp_card11.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac11"></a>
      </div>  
       <div class="card-text text-right">
           <?php       lock('ac11');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./cpp_content/cpp_card12.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac12"></a>
      </div>
       <div class="card-text text-right">
             <?php       lock('ac12');      ?>
      </div>
...
<div class="row mt-3 ml-3 mr-3 mb-3">
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./cpp_content/cpp_card13.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac13"></a>
      </div>
      <div class="card-text text-right">
           <?php       lock('ac13');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./cpp_content/cpp_card14.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac14"></a>
      </div>
   <div class="card-text text-right">
         <?php       lock('ac14');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./cpp_content/cpp_card15.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac15"></a>
      </div>
      <div class="card-text text-right">
         <?php       lock('ac15');      ?>
      </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <h6 class="card-title" style="visibility: hidden;">Data Types</h6>
       <div>
                  <a href="./cpp_content/cpp_card16.php"  class="position-absolute w-100 h-100 text-decoration-none th" style="pointer-events: none;" id="ac16"></a>
      </div>
       <div class="card-text text-right">
           <?php       lock('ac16');      ?>
      </div>
