...
$objects=new check;
$val=$objects->getidfrom($userarray['email'],$_SESSION['connection']);
echo $val;
if($val==$_COOKIE['userid']){
    echo "it matches with cookie";
}
...
//echo $userarray['username'];
    ...
    $q1="select * from c_course where uid='$userid1'";
...
<meta property="og:title" content="ThoughtBitz">
<meta property="og:description" content="Aimed to provide the common platform">
...
<meta property="twitter:title" content="ThoughtBitz">
<meta property="twitter:description" content="Aimed to provide the common platform">
    ...
    <div class="container">
        <div class="row  text-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="col-sm-3 h4 text-center">Posts:</div>
                                    ...
                                    <h4 class="mb-0">
                                        ...
                                        <span class="badge"><i class="fa fa-eye" style="color:yellow;font-size:1.3rem">&nbsp;&nbsp;</i><?php echo checkviews($userid);                                        ?> Views</span>  
                                    </h4>
                                    </div>
            ...
            <div class="row">
                    ...
                    <h1>Posts</h1>
                            <?php
                $q="select * from blogs where userid1=$userid";
                    ...
                    <div class="card mb-3" style="border-radius:15px;background-image:url(https://i.pinimg.com/originals/9e/74/7d/9e747dd76f1be3d062748e6b3d030f6b.jpg)" >
                        <div class="row no-gutters">
                         ...
                         <img src="https://www.thoughtbitz.ml/Blogs/uploads/'.$row1['thumbnail'].'"
                            ...
                            <div class="col-sm-8">
                            <div class="card-body">
                                <h5 class="card-title"><a href="../../Blogs/WatchBlog.php?blogid='.urlencode(base64_encode("blogs".$row1['blogid'])).' && check='.$check.'"  class="card-title" style="text-decoration:none;font-weight:bolder;color:black;padding-top:15px;font-size:3rem;" >&nbsp;'.substr($row1["blogtitle"],0,30).'..</a></h5>
        ...
        ?>
                ...
                <div class="tab-pane" id="edit">
                    <form role="form" method="POST" action="useredit.php" enctype="multipart/form-data">
...
<div style="width:10rem;height:10rem;border:1px dashed black;box-sizing: border-box;position:relative"><img id="image" src="data:image/jpeg;base64,'.base64_encode($userarray['profileimage'] ).'" style="width:9.8rem;height:9.8rem;position:absolute;left:0px"/><label for="file" ><i class="fa fa-pencil" aria-hidden="true" style="margin-top:65%;left:75%;position:absolute;color:cyan;font-size:2rem"></i></label></div>
                    ...
                    <form role="form" method="POST" action="useredit.php">
                        <div class="form-group row">
                     ...
                     <!--<form role="form" method="POST" action="useredit.php">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" type="text" value="'. $userarray['email'].'"  name="Email">
                            </div>
                            <div class="col-sm-3">
                                <input type="submit"  name="update2" value="Update" class="btn btn-success">
                            </div>  
